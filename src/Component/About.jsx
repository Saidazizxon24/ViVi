                ...
                <div className="mb-10 pt-[112px] px-[20px] pb-[240px] mx-auto">
                    ...
                    <div className="flex justify-around items-center">
                        <div className="w-[600px]">
                            <h2 className="font-semibold text-4xl">Trusted by over 2,400 schools, 120,000 classrooms,and 825,000 teachers and students.</h2>
                        </div>
                        <div className="grid grid-cols-3 gap-10 items-center">
                            <div className="relative">
                                <a href="">
                                    <img
                                        src="https://www.vivi.io/wp-content/uploads/2024/02/mvla_uhsd_logo_grey.png"
                                        alt="grey_icon"
                                        className="transition-opacity duration-300 ease-in-out"
                                    />

                                    <img
                                        src="https://www.vivi.io/wp-content/uploads/2024/02/mvla_uhsd_logo.png"
                                        alt="blue_icon"
